...
def precipitation_cmap():
    ...
    hex_list = [
        '#c1c1c1', '#99ffff', '#00ccff', '#0099ff', '#0066ff', 
        '#339900', '#33ff00', '#ffff00', '#ffcc00', '#ff9900',
        '#ff0000', '#cc0000', '#990000', '#990099', '#cc00cc', 
        '#ff00ff'
    ]
...
def temperature_cmap():
    ...
    hex_list = [
        '#0000cd', '#0000ff', '#0040ff', '#006aff', '#0095ff', 
        '#00bfff', '#00eaff', '#00ffea', '#80fff4', '#117388', 
        '#207e92', '#2e899c', '#3d93a6', '#4c9eb0', '#5ba9ba', 
        '#69b4c4', '#78bfce' ,'#87cad8', '#96d4e2', '#a4dfec', 
        '#b3eaf6', '#0c924b', '#1d9a51', '#2fa257', '#40a95e', 
        '#51b164', '#62b96a', '#74c170', '#85c876', '#96d07c', 
        '#a7d883', '#b9e089', '#cae78f', '#dbef95', '#f4f4c3', 
        '#f7e78a', '#f4d576', '#f1c362', '#eeb14e', '#ea9e3a', 
        '#e78c26', '#e07b03', '#ed5138', '#ed1759', '#ad053a', 
        '#780101', '#c3a4cd', '#af86bd'
    ]
    mycmap, mynorm = from_colorlist_to_cmap_norm(boundary, hex_list)
    return mycmap, mynorm, boundary, color_under, color_over
...
def wind_speed_cmap_ms():
    ...
    boundary = [
        0.1, 0.3, 1.6, 3.4, 5.5, 
        8.0, 10.8, 13.9, 17.2, 20.8, 
        24.5, 28.5, 32.7, 37.0, 41.5, 
        46.2, 51.0, 56.1, 61.3
    ]
    hex_list = [
        '#e6e6e6', '#d3d3d3', '#979797', '#646464', '#96d2fa', 
